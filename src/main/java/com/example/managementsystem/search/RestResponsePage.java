...
public class RestResponsePage<T> extends PageImpl<T> {
    ...
    public RestResponsePage(@JsonProperty("content") List<T> content, @JsonProperty("number") int number, @JsonProperty("size") int size,
        ...
        super(content, PageRequest.of(number < 0 ? 0 : number, size < 1 ? 1 : size), totalElements);
    }
    ...
    public RestResponsePage(List<T> content) {
        super(content, PageRequest.of(0, 10), 0);
    }

    public RestResponsePage() {
        super(Collections.emptyList(), PageRequest.of(0, 10), 0);
    }
