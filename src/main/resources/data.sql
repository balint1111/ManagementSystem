...
INSERT INTO TOOL_CATEGORY ( CATEGORY , DESCRIPTION , MAINTENANCE_INTERVAL, MAINTENANCE_DESCRIPTION, MAINTENANCE_ESTIMATED_TIME)
    VALUES ( 'testCategory' , 'description' , 'WEEK', 'karbantartás leírás', 8);
INSERT INTO TOOL_CATEGORY ( CATEGORY , DESCRIPTION , MAINTENANCE_INTERVAL, MAINTENANCE_DESCRIPTION, MAINTENANCE_ESTIMATED_TIME)
    VALUES ( 'testCategory2' , 'description2' , 'QUARTER', 'karbantartás leírás2', 4);
...
INSERT INTO TOOL ( NAME , IDENTIFIER ,  DESCRIPTION, TOOL_CATEGORY_ID) VALUES ( 'testTool2' , 'tool-0002' , 'testTool2', 2);
INSERT INTO ISSUE ( TOOL_ID , date_time, ESTIMATED_TIME ,  TITLE, STATUS ) VALUES ( 1 , '2022-01-01T00:00:00Z' , 8, 'TESZT FELADAT', 'NEW');
INSERT INTO ISSUE ( TOOL_ID , date_time, ESTIMATED_TIME ,  TITLE, STATUS ) VALUES ( 2 , '2022-01-01T00:00:00Z' , 8, 'TESZT FELADAT2', 'NEW');
INSERT INTO ISSUE_LOG ( ISSUE_ID , DESCRIPTION) VALUES ( 1 , 'NEW STATUS');
INSERT INTO ISSUE_LOG ( ISSUE_ID , DESCRIPTION) VALUES ( 2 , 'NEW STATUS');